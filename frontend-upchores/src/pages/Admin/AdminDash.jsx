...
export const AdminDashboard = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Search & Filters */}
      <div className="bg-white shadow-md p-4 flex flex-wrap gap-3 justify-between items-center mt-4 mx-4 rounded-lg">
        <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2 w-full md:w-1/3">
          <FaSearch className="text-gray-500 mr-2" />
          <input
            type="text"
        ...
        <select className="border border-gray-300 rounded-lg px-3 py-2 md:w-1/6 w-full">
          <option>All Roles</option>
        </select>
        <select className="border border-gray-300 rounded-lg px-3 py-2 md:w-1/6 w-full">
          <option>All Locations</option>
      ...
      {/* Talent List */}
      <div className="mt-6 mx-4 grid grid-cols-1   gap-4">
        {talents.map((talent, index) => (
          <div
            key={index}
          ...
          >
            <img
              ...
              className="w-16 h-16 rounded-full object-cover"
            />
            <div className="ml-0 sm:ml-4 mt-2 sm:mt-0 flex-1 text-center sm:text-left">
              <h2 className="text-lg font-semibold">{talent.name}</h2>
              <p className="text-gray-500">{talent.role}</p>
              <p className="text-gray-400">{talent.location}</p>
              <p className="text-blue-500 font-medium">
